...
if spritestate="attack"
{
 ...
 walk=false
 look_to_target()
 if alarm[0]=-1 or image_ignore=asset_get_index(sprite_attack)  {set_attack_ranged_stop(asset_get_index(sprite_attack),0.2,11,f_agi*1.8,unit_angel_3_projectile,x+image_xscale*5,y-10)}
}   
